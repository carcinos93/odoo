...
class OrdenCompra(models.Model):
    _name = 'adquisicion.orden_compra'
    ...
    detalle = fields.One2many(comodel_name='adquisicion.detalle_orden_compra', inverse_name='ordenCompra_ids', string='Detalle')


class OrdenCompraDetalle(models.Model):
    _name = 'adquisicion.detalle_orden_compra'
    ...
    ordenCompra_ids = fields.Many2one(comodel_name='adquisicion.orden_compra', string='Orden compra')
