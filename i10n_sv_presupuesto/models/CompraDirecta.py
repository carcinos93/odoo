...
class CompraDirecta(models.Model):
    _name = 'presupuesto.compra_directa'
    ...
    documentos = fields.One2many(comodel_name='presupuesto.compra_directa_documentos', inverse_name='compraDirecta_ids',
                                        string='Documentos')
    estado = fields.Boolean(string='Estado')


class DocumentosCompraDirecta(models.Model):
    _name = 'presupuesto.compra_directa_documentos'
    ...
    compraDirecta_ids = fields.Many2one(comodel_name='presupuesto.compra_directa', string='Compra directa')
