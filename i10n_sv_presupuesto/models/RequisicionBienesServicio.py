...
class RequisicionBienesServicio(models.Model):
    ...
    documentos = fields.One2many(comodel_name='presupuesto.requisicion_documentos', inverse_name='requisicion_ids',
                                        string='Documentos')

class Documentos(models.Model):
    _name = 'presupuesto.requisicion_documentos'
    ...
    requisicion_ids = fields.Many2one(comodel_name='presupuesto.requisicion', string='Requisicion')