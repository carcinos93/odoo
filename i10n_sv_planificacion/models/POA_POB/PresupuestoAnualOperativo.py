...
class PresupuestoOperativo(models.Model):
    _name = 'planificacion.presupuesto_operativo'
    ...
    detalle = fields.One2many(comodel_name='planificacion.presupuesto_operativo_detalle',inverse_name='presupuestoAnual_ids',string='Detalle', copy=True)
